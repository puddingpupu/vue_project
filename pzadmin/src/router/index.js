...
import Order from '../views/dashboard/index.vue'
import Staff from '../views/vppz/order/index.vue'
import Dashboard from '../views/vppz/staff/index.vue'
...
const routes=[
    { 
        ...
        children: [
          ...
          {
            path: 'vppz',
            meta: { id: '3', name: '土豆商店', icon: 'BellFilled' },
            children: [
              {
                path: '',
                alias: ['staff'],
                meta: { id: '1', name: '商品管理', icon: 'Checked', path: '/vppz/staff', describe: '商店管理者可以进行创建和修改，设置对应生效状态控制C端选择' },
                component: Staff
              },
              {
                path: 'order',
